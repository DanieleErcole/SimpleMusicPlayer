package it.danieleercole.soundbox.services
...
import it.danieleercole.soundbox.utils.albumUriBase
import it.danieleercole.soundbox.utils.nullableIntColumn
import it.danieleercole.soundbox.utils.nullableLongColumn
import it.danieleercole.soundbox.utils.nullableStringColumn
        ...
        cursor?.use {
            ...
            while (it.moveToNext()) {
                ...
                val album = albumId?.let {
                    Album(
                        id = it,
                        name = albumTitle?.ifEmpty { DefaultAlbum.UNKNOWN_ALBUM_NAME }
                            ?: DefaultAlbum.UNKNOWN_ALBUM_NAME,
                        thumbnail = albumUri,
